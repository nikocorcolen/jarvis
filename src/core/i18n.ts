...
const es: Record<TranslationKey, string> = {
  ...
  'prompt.arch.output': 'SALIDA:\nEdita el archivo design.md existente respetando la estructura de sus secciones.\nMantén el status como "draft" en el front-matter; el usuario ejecutará\n`jarvis spec approve design` para avanzar.\n\nEMPIEZA listando las historias de usuario y requerimientos que abordarás,\nluego pregúntame sobre cualquier ambigüedad o compromiso que veas ANTES de escribir.',
  ...
  'prompt.tech.output': 'SALIDA:\nEdita el archivo tasks.md existente respetando la estructura de sus secciones.\nMantén el status como "draft" en el front-matter; el usuario ejecutará\n`jarvis spec approve tasks` para marcar este spec listo para\nimplementación.\n\nEMPIEZA escribiendo la lista completa de tareas. No se necesitan preguntas\naclaratorias a menos que el diseño tenga vacíos — en ese caso, lista los vacíos\nprimero y espera mis respuestas antes de escribir las tareas.',
};
